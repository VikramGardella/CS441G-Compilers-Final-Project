...
Stm : Decl _SYMB_5 {  $$ = new SDecl($1); YY_RESULT_Stm_= $$; } 
  ...
  | _SYMB_14 _SYMB_0 Exp _SYMB_1 Stm {  $$ = new SWhile($3, $5); YY_RESULT_Stm_= $$; }
  | _SYMB_13 Exp _SYMB_5 {  $$ = new SReturn($2); YY_RESULT_Stm_= $$; }
;
...
;
Type : _SYMB_12 {  $$ = new TInt(); YY_RESULT_Type_= $$; } 
